package br.com.bossini.previsaodotempofateccarapicuibasi;
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (url != null){
                    ...
                    Snackbar.make(findViewById(R.id.coordinatorLayout), getString(R.string.invalid_url), Snackbar.LENGTH_LONG);
                }
            }
        });
    }
